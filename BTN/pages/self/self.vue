			...
			<view class="group" @click="toUserInfo">
				<view class="userinfo">
					<view class="pic">
						...
						<image v-else src="/static/my-active.jpg" mode="aspectFill"></image>
					</view>
				...
				<view class="more">
					<u-icon name="arrow-right" color="#ffffff" size="20" style="padding-right: 10rpx;"></u-icon>
				</view>
			</view>
			...
			<view class="list">
				<view class="group">
					<view class="item" @click="myArticle">
						<view class="left">
							<u-icon name="file-text" color="#576a64" size="27" style="padding-right: 10rpx;"></u-icon>
							<text class="text">我的帖子</text>
						</view>
						<view class="right">
							<u-icon name="arrow-right" color="#576a64" size="15" style="padding-right: 10rpx;"></u-icon>

						</view>
					</view>
					<view class="item" @click="myLike">
						<view class="left">
							<u-icon name="thumb-up" color="#576a64" size="27" style="padding-right: 10rpx;"></u-icon>
					...
					<view class="item">
						<view class="left">
							<u-icon name="chat" color="#576a64" size="27" style="padding-right: 10rpx;"></u-icon>
				...
				<view class="group">
					<view class="item">
						<view class="left">
							<u-icon name="tags" color="#576a64" size="27" style="padding-right: 10rpx;"></u-icon>
					...
					<view class="item" @click="goFeedback">
						<view class="left">
							<u-icon name="email" color="#576a64" size="27" style="padding-right: 10rpx;"></u-icon>
				...
				<view class="group">
					<view class="item" @click="logout">
						<view class="left">
							<u-icon name="rewind-left" color="#576a64" size="27" style="padding-right: 10rpx;"></u-icon>
	...
	export default {
		...
		methods:{
			async getTotal(){
				...
				let artCount=await db.collection("luntan_article").where(`user_id == $cloudEnv_uid`).count();
				this.totalObj.artNum=artCount.result.total;
				
				let likeCount=await db.collection("luntan_article").where(`user_id == $cloudEnv_uid`)
				.groupBy('user_id')
